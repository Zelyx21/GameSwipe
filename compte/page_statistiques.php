        ...
        <div class="gauche">
            <div class="stats">
                <div class="stat-row"><p class="stat-label">
                    <img src="../logo/horloge.svg" alt="Horloge">
                    Cartes Swipé :</p><p class="stat-value"><?php echo $total; ?></p></div>
                <div class="stat-row"><p class="stat-label">
                    <img src="../logo/boutons/Nom=Like, Etat=Normal.svg" alt="Like">
                    Cartes Liké :<p class="stat-value"><?php echo $like; ?></p></div>
                <div class="stat-row"><p class="stat-label">
                    <img src="../logo/boutons/Nom=Dislike, Etat=Normal.svg" alt="Dislike">
                    Cartes Disliké :</p><p class="stat-value"><?php echo $dislike; ?></p></div>
                <div class="stat-row"><p class="stat-label">
                    <img src="../logo/boutons/Nom=Favori, Etat=Normal.svg" alt="Favori">
